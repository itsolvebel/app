...
const RBTL = () => {
  ...
  return (
    <div className="container-fluid w-100 flex items-center justify-center">
      <div className="container-fluid flex w-[100%] max-w-[1700px] flex-col p-6 md:p-10 lg:p-16">
        <h2 className="font-sans text-3xl text-[white] lg:text-5xl">
        ...
        <div className="relative flex justify-end">
          <div className="w-[0%] lg:w-[20%] ">
            <svg
              ...
              className="absolute bottom-5 left-5 z-0 w-[25%]"
              ref={svgRef}
          ...
          <div className="z-1  relative mt-16 w-[100%] rounded-xl border border-[#15B1FE] bg-slate-900 p-4 md:p-10 lg:w-[80%] lg:p-16">
            <div className="flex flex-col">
              <div className="w-100 flex flex-col gap-10 border-b border-b-[#15B1FE] pb-10 md:flex-row">
                <div className="flex w-[100%] flex-col md:w-[50%]">
                  <h3 className="text-xl text-white md:text-2xl lg:text-3xl">
                    Unlock your business&apos;s potential with our creative
                    solutions.
                  </h3>
                  <p className="text-md my-6 text-[#ACACAC] md:my-10 md:text-lg lg:my-16">
                ...
                <div className="min-h-[200px] w-[100%] rounded-lg border border-[#15B1FE] md:w-[50%]">
                  <img src="" alt="pic" className="w-100" />
                </div>
              </div>
              <div className="flex flex-col gap-10 pt-16 md:flex-row">
                <div className="flex w-[100%] flex-col md:w-[50%] ">
                  <h3 className="text-xl text-white md:text-2xl lg:text-3xl">
